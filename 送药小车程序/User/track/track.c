...
int D_AD_VALUE   = -108; 	//确定左右传感器差值  -115
int LEFT_MAX     = 3243;   	//左传感器峰值  3748
int RIGHT_MAX    = 3213;  	//右传感器峰值  3688
int MID_MAX      = 3213;  		//中间传感器峰值  3688
int LEFT_THERSH  = 1832;	//左传感器阈值  1867
int RIGHT_THERSH = 2013;	//右传感器阈值  1937
int LEFT_SPAN    = 5561;		//传感器向左移动跳跃差值   5992
int RIGHT_SPAN   = -6245;	//传感器向右移动跳跃差值     -6032
